        ...
        {isEditing ? (
          <>
            ...
            <div className='flex justify-end gap-2 text-xs'>
              ...
              <Button gradientDuoTone='purpleToBlue' type='button' size='sm' outline onClick={() => setIsEditing(false)}>Cancel</Button>
            </div>
          </>
        ) : (
          <>
            <p className='text-gray-500 pb-2'>{comment.content}</p>
            <div className='flex items-center gap-2 text-sm border-t dark:border-t-gray-600 max-w-fit pt-2 '>
