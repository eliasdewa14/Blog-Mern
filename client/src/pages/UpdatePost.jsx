  ...
  return (
    <div className="p-3 max-w-3xl mx-auto min-h-screen">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        {formData.image && <img src={formData.image} alt="post image" className='w-full h-100  object-cover' />}
        ...
        <Button type="submit" gradientDuoTone='purpleToPink'>Update and Publish</Button>
